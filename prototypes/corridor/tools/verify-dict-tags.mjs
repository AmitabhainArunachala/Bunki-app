...
check('app index + shard validators require schema v3 and never accept v2',
  [...app.matchAll(/schemaVersion !== 3/g)].length === 2 &&
    [...app.matchAll(/schemaVersion !== 2/g)].length === 0,
  'integrated 2026-08-24 — the pre-integration tripwire asserted the inverse');
