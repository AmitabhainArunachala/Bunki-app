...
function saveStore() {
  try {
    localStorage.setItem(STORE_KEY, JSON.stringify({ taken: S.taken, lists: S.lists, srs: S.srs, lessonsDone: S.lessonsDone, aiReading: S.aiReading, suspended: S.suspended, readDone: S.readDone, readerPos: S.readerPos }));
  } catch {
