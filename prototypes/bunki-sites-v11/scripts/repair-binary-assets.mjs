// GitHub's text-oriented source transfer can mangle binary public assets.
// The authoritative bytes ship in the installed npm packages, so restore
// them after every install before Bunki is built, tested, or launched.
...
fs.mkdirSync(dictDst, { recursive: true });
...
if (head[0] !== 0x1f || head[1] !== 0x8b) {
  throw new Error("Kuromoji dictionary repair did not produce valid gzip data");
}
