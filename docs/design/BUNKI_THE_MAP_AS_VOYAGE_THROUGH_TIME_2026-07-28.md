...
| **街道** | Edo                     | The 五街道 from Nihonbashi — Tōkaidō (53 post stations), Nakasendō (69), Nikkō, Ōshū, Kōshū; 一里塚 every _ri_; 宿場 towns | The literate-commoner stratum: 漢語 in daily use, trade and craft vocabulary, the vocabulary of travel and place |
...
question: _how did this get here?_

---

## 3. The cultural weaving — my answer, since you asked for it

The operator's own words: _"That's a good question because I don't have a clean
answer. So maybe go deeper into what you think… or how you think this should
work."_ So here is my actual position, and the reason for it.
...
abandoned, because it is _beside_ the learning rather than _under_ it.
...
That gives us something no flashcard app has: a word's _place_ is meaningful
...
- Under the 律令 system, a **駅家 (うまや)** was a post-station placed along the
  official roads — by the code, roughly every 30 _ri_ — holding horses, lodging
...
奥 is _interior, depth, the back of a space_. 奥さん is "the person of the inner
...
**This is the model for every cultural note in the app**: the note is _the
character explaining itself_, never an encyclopedia paragraph.
...
**the character's real story**, which is more memorable _and_ true, and which
...
_"between the animation and the lessons it could be a gentle ambient vibe that
can deepen and be a selling point."_ I agree, with one sharpening:
...
- **The atmosphere is always on and never asks anything of you.** The era
  ...
  nothing.
- **Words are never on unless you reach for them.** A cultural note is _one
  line_ on the museum card. Tapping opens the thread. Nothing cultural ever
...
The operator's direction: _"整理: 案内人 か 先輩 か 導く人"_, a **constant
presence**, but _"let's hold off on defining a fixed character."_ And: _"most of
...
SRS system helps dictate where the learning bifurcates to."_
...
_"nothing could actually map the particular gaps that developed over the years."_
...
capability lens that lags the others. The guide _narrates and routes_; it does
...
Being the one who _notices_ the branch and _offers the road_ is a bigger role
