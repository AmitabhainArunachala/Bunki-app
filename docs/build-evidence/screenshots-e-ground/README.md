...
- Scheme: light
- Meiji → now. 素鼠 sunezumi concrete by day, 褐 kachi night ground under 消炭 keshizumi structure after dark. The only register where emitted light is permitted: four real signals are offered and three are lit, in 銀朱 ginshu and 山吹 yamabuki.
