...
| OD-2  | The 30 recovered articles: approve/reject each      | pending  | review queue |
| OD-3  | Feed review queue: standing approval flow           | pending  | —            |
| OD-4a | Wayfinder #35: name the atom and the graph          | pending  | —            |
| OD-4b | Wayfinder #38/#40: card formats, override policy    | pending  | —            |
| OD-5  | #49 rename BUNKI → KAIRO (prepared, fired on word)  | pending  | —            |
| OD-6  | TTS voices (licensed assets, cost; 澄/語/話 styles) | pending  | —            |
