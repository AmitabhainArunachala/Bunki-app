...
test('monthly truth switches exact UTC months, survives reload, and keeps unresolved authority visible', async ({
  ...
  await page.clock.setFixedTime(new Date('2026-07-31T23:59:59.999Z'));
  ...
  await page.clock.setFixedTime(new Date('2026-08-01T00:00:00.000Z'));
  ...
  await visibleTestId(page, 'nav-monthly').click();
